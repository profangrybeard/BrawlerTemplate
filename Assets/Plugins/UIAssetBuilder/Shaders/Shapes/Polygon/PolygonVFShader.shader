...
Shader"UIAB/Polygon"
{
    Properties
    {
        ...
        // POLYGON
        [PerRendererData] _Polygon_Size_Roundness_InnerAngle_OffsetMod("Polygon Size/Roundness/InnerAngle/OffsetMod", Vector) = (10,5,1,1)
        [PerRendererData] _Polygon_Helper_Data("Polygon Helper Data", Vector) = (0,0,0,0)
        // EFFECTS
