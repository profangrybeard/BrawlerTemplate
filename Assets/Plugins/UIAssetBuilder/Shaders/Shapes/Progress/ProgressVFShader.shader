...
Shader"UIAB/Progress"
{
    Properties
    {
        ...
        // PROGRESS
        [PerRendererData] _Progress_Type_Size_Thickness_Ratio("Progress Type/Size/Thickness/Ratio", Vector) = (0,100,4,0)
        [PerRendererData] _Progress_Progress("Progress", Vector) = (0,0,0,0)
        // EFFECTS
        ...
        // EXTRA SETTINGS
        [PerRendererData] _Extra_CenterOffset("Extra Settings Offset", Vector) = (0,0,0,0)   
