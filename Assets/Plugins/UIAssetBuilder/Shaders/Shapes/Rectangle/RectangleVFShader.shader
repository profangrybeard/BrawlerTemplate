Shader"UIAB/Rectangle"
{
    Properties
    {
        ...
        // RECTANGLE
        [PerRendererData] _Rectangle_Width("Rectangle Width", Float) = 1.0
        [PerRendererData] _Rectangle_Height("Rectangle Height", Float) = 1.0
        [PerRendererData] _Rectangle_Corners("Rectangle Corners", Vector) = (1,1,0,0)
        // EFFECTS
